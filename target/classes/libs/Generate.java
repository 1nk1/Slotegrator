...
public class Generate {
    ...
    private static String[] name = { "Macaulay", "Domonic", "Duncan", "Rayonder", "Breadin", "Monika", "Emmeline", "Zorking", "Rosebalt", "Marcokov", "Julian", "Rosemara", "Finley", "Werner", "Palacios", "Christos",};
    private static String[] surName = { "Sanford", "Bakerin", "Alston", "Finley", "Yoderin", "Werner", "Duncan", "Lambert", "Palacios", "Zavala", "Handley" };
